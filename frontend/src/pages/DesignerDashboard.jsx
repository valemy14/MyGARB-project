...
export default function DesignerDashboard() {
  ...
  const handlePortfolioUpload = async () => {
    ...
    try {
      ...
      setPortfolioForm({ title: '', description: '', category: '', image: null, preview: null });
      ...
      <div className="dd-page">
        ...
        <div className="dd-topbar">
          ...
          <div className="dd-topbar-right">
            ...
            {profile && (
              <a
                href={`/designer/${profile._id}`}
                className="dd-view-profile"
              >
                View Public Profile →
              </a>
            )}
          ...
          <main className="dd-main">
            ...
            {activeTab === 'profile' && (
              <>
                ...
                <div className="dd-card">
                  ...
                  <div className="dd-form-grid">
                    <div className="dd-form-group full">
                      ...
                      <input
                        className={`dd-input ${errors.businessName ? 'error' : ''}`}
                    ...
                    <div className="dd-form-group full">
                      <label className="dd-label">
                        Bio * <span>({form.bio.trim().length}/50 min)</span>
                      </label>
                      <textarea
                        className={`dd-textarea ${errors.bio ? 'error' : ''}`}
                        value={form.bio}
                        onChange={e => {
                ...
                <div className="dd-card">
                  ...
                  <div className="dd-specialties">
                    {SPECIALTIES.map(s => (
                      <button
                        key={s}
                        type="button"
                        className={`dd-specialty-btn ${form.specialties.includes(s) ? 'active' : ''}`}
                  ...
                  {errors.specialties && (
                    <span className="dd-error-msg" style={{ display: 'block', marginTop: 8 }}>
                      {errors.specialties}
                    </span>
                  )}
                </div>
                    ...
                    <div className="dd-form-group">
                      ...
                      <div className="dd-toggle-row">
                        <span className="dd-toggle-label">
                          {form.availability ? 'Open for orders' : 'Not available'}
                        </span>
            ...
            {activeTab === 'portfolio' && (
              <>
                ...
                {/* Upload form */}
                <div className="dd-card">
                  <p className="dd-card-title">Add New Image</p>
                  ...
                  >
                    {portfolioForm.preview ? (
                      <img
                        src={portfolioForm.preview}
                        alt="Preview"
                        className="dd-upload-preview"
                      />
                    ) : (
                      <>
                  ...
                  <button
                    ...
                    disabled={uploading || !portfolioForm.image}
                  >
                ...
                {/* Existing portfolio */}
                <div className="dd-card">
                  <p className="dd-card-title">
                    Your Portfolio ({profile?.portfolio?.length || 0} images)
                  </p>
                  {!profile?.portfolio?.length ? (
                    <div className="dd-empty-portfolio">
                      <div style={{ fontSize: '2rem', marginBottom: 8 }}>◈</div>
                      <p>No images yet — upload your first piece above</p>
                    </div>
                  ) : (
